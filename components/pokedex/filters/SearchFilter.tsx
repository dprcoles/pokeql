...
const SearchFilter: React.FC<SearchFilterProps> = ({ initialSearch, updateSearch }) => {
  ...
  return (
    <div className="[ POKEMON__Search ] flex bg-white border-gray-100 rounded-md">
      <input
        className="p-4 border-2 focus:border-page-alt-color w-full"
        type="search"
        value={search}
      ...
      />
      <div className="flex text-page-alt-color justify-items-center border-2 border-transparent bg-pink-100 hover:bg-page-alt-color hover:text-white">
